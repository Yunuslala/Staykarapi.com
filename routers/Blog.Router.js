...
const { AddBlogs, UpdateBlogs, GetAllBlogs, DeleteBlogs, GetSingleBlog } = require("../controllers/Blog.Controller");
...
BlogRouter.route("/User/GetSingle/:id").patch(GetSingleBlog);
